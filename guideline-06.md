...
* Storefronts are not services, and a plugin that acts only as a front-end for products to be purchased from external systems will not be accepted into the repository.